 ...
 */
@Service
public class AdminEditMyAccountServiceImpl implements
        AdminEditMyAccountService {
    ...
    @Override
    public AdminEditMyAccountInitialData getEditMyAccountInitialData(
            User user ) {

        UserTransfer userTransfer = createUserTransfer( user );

        return new AdminEditMyAccountInitialData( userTransfer );
    }
