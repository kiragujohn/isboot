 ...
 * @date 23/05/2019
 */
public class AdminEditMyAccountUserDetailsRequest {
    ...
    public AdminEditMyAccountUserDetailsRequest( Long userId,
            String name, String email,
            String phone, String firstName, String lastName, String firstLine,
    ...
    public AdminEditMyAccountUserDetailsRequest() {
